"""Runtime settings for collector_defra_uk."""
...
SCHEMA_NAME = "collector_defra_uk"
...
USER_AGENT = os.getenv("COLLECTOR_USER_AGENT", "collector_defra_uk/0.1 (+https://github.com/lucasweber1202/collector_defra_uk)")
